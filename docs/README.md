...
3. [back/JWT.md](back/JWT.md) : **où est physiquement ton jeton d'authentification**, ce qu'il contient, par où il passe
...
| [back/JWT.md](back/JWT.md) | Le jeton : sa structure, son payload, les deux champs `role`, où il vit, pourquoi le serveur peut lui faire confiance, ce qu'un attaquant peut ou non en faire |
...
L'authentification se lit en trois temps : `supabase.md` dit **qui émet** le jeton,
